<x-auth>
    @if (session('gagal'))
    <div class="absolute top-5 right-5 p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50"
        role="alert">
                ...
                <form class="space-y-4 md:space-y-6" action="signin" method="post">
                    ...
                    <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                        Belum punya akun? <a href="signup"
                            class="font-medium text-red-600 hover:underline dark:text-red-500">Register here</a>
                    </p>
                </form>
            </div>
        </div>
