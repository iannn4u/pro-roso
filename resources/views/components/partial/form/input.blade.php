...
focus:ring-2',' focus:ring-inset',' focus:ring-red-600',' sm:text-sm',' sm:leading-6' ,'outline-none']) !!}>

@if($error)
<ul class="text-red-500 text-xs space-y-1 text-gray-500 list-disc list-inside mt-1.5">
