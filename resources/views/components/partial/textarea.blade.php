<div class="mb-4">
  ...
  <textarea
    class="block w-full rounded-lg border outline-none border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-gray-500 focus:ring-2 ring-inset focus:ring-gray-500 @error($attributes->get('name')) animate-shake ring-gray-600 ring-2 @enderror"
