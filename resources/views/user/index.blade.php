<x-user :$title :$user :$jumlahPesan :$files :$pesan>
    ...
    @foreach ($files as $file)
        <a href="file/{{ $file->id_file }}"
            class="w-full h-52 max-w-sm p-2 bg-gray-100 border border-gray-200 rounded-lg shadow hover:bg-gray-200">
            <h2>{{ $file->original_filename }}</h2>
            <div class="overflow-hidden h-40 mt-2 cursor-default bg-white grid place-items-center">
                            ...
                            <div class="dropdown no-arrow">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                    ...
                                    <button class="dropdown-item" id="salin"><i class="fa-solid fa-paperclip"
                                        ...
                                        link</button>
                                    <button id="bSearch" type="button" class="dropdown-item"
                                        data-id_file="{{ $file->id_file }}" data-bs-toggle="modal"
