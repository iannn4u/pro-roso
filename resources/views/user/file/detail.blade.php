                ...
                <div class="row g-0">
                    <div class="col-md-5 d-flex justify-content-center align-items-center">
                        @if (explode('/', $file['mime_type'])[0] == 'image')
                            <img src="{{ asset('storage/' . $file->generate_filename) }}" class="img-fluid rounded-start mr-2"
                                alt="{{ $file->judul_file }}">
                        @else
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                version="1.1" width="200" viewBox="0 0 256 256" xml:space="preserve">
                    ...
                    <div class="col-md-7">
                        <div class="card-body p-0 py-4">
                            <div class="d-flex justify-content-between position-relative">
                                <h5 class="h3 card-title text-uppercase mb-3">{{ $file->judul_file }}</h5>
                                @if (request()->is('file/*'))
                            ...
                            <div class="card">
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item"><b>Nama File</b> : <?= $file['original_filename'] ?></li>
                                    <li class="list-group-item"><b>Size</b> : <?= $file['file_size'] ?></li>
                                    <li class="list-group-item"><b>Deskripsi</b> : @if (!$file['deskripsi'])
                                            -
                                        @endif
                                        <?= $file['deskripsi'] ?></li>
                                </ul>
                            ...
                            <div class="text-center mt-4">
                                <a href="/file/{{ $file->id_file }}/edit" class="btn btn-success float-end">edit</a>
                                <div class="mt-3">
