                    ...
                    <div class="col-md-7">
                        <div class="card-body p-0 py-4">
                            <div class="d-flex justify-content-between position-relative">
                                ...
                                @else 
                                <a href="/download/{{ $file->id_file }}" class="btn btn-success position-absolute top-0 end-0 "><i
                            ...
                            <div class="card">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item"><b>Deskripsi</b> : @if(!$file['deskripsi']) - @endif<?= $file['deskripsi'] ?></li>
                                </ul>
                            </div>
