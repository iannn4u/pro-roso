    ...
    <a href="/file/create" class="p-2 rounded-xl shadow-md text-base bg-white flex items-center gap-4 px-3 w-1/2 transition-all hover:bg-gray-200"><span class="text-3xl mb-1">+</span> Baru</a>

    <div class="mt-5">
        <div class="mb-3 px-3 py-1 rounded-full {{ request()->is('/') ? 'bg-yellow-100' : 'hover:bg-gray-200' }}">
